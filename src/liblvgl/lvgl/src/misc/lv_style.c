...
const uint8_t lv_style_builtin_prop_flag_lookup_table[LV_STYLE_NUM_BUILT_IN_PROPS] = {
    ...
    [LV_STYLE_TRANSFORM_SCALE_X] =
        LV_STYLE_PROP_FLAG_EXT_DRAW_UPDATE | LV_STYLE_PROP_FLAG_LAYER_UPDATE | LV_STYLE_PROP_FLAG_TRANSFORM,
...
lv_style_value_t lv_style_prop_get_default(lv_style_prop_t prop)
{
    ...
    case LV_STYLE_TRANSFORM_SCALE_Y:
        return (lv_style_value_t){.num = LV_SCALE_NONE};
    case LV_STYLE_BG_COLOR:
        return (lv_style_value_t){.color = white};
    ...
    case LV_STYLE_IMAGE_RECOLOR:
        return (lv_style_value_t){.color = black};
    case LV_STYLE_OPA:
    ...
    case LV_STYLE_ARC_OPA:
        return (lv_style_value_t){.num = LV_OPA_COVER};
    case LV_STYLE_BG_GRAD_STOP:
        return (lv_style_value_t){.num = 255};
    case LV_STYLE_BORDER_SIDE:
        return (lv_style_value_t){.num = LV_BORDER_SIDE_FULL};
    case LV_STYLE_TEXT_FONT:
        return (lv_style_value_t){.ptr = LV_FONT_DEFAULT};
    case LV_STYLE_MAX_WIDTH:
    case LV_STYLE_MAX_HEIGHT:
        return (lv_style_value_t){.num = LV_COORD_MAX};
    case LV_STYLE_ROTARY_SENSITIVITY:
        return (lv_style_value_t){.num = 256};
    default:
        return (lv_style_value_t){.ptr = NULL};
    }
}
