 ...
 */
static uint32_t lv_text_get_next_word(const char *txt, const lv_font_t *font, int32_t letter_space, int32_t max_width,
...
uint32_t lv_text_get_next_line(const char *txt, const lv_font_t *font, int32_t letter_space, int32_t max_width,
 ...
 * @param txt pointer to '\0' terminated string
 * @param i start byte index in 'txt' where to start. After the call it will point to the previous ISO8859-1 coded char
 * in 'txt'.
 * @return the decoded ISO8859-1 character.
 */
