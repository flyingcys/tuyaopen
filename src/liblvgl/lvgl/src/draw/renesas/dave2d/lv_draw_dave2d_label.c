                                          ...
                                          lv_draw_fill_dsc_t *fill_draw_dsc, const lv_area_t *fill_area)
{
    ...
    if (glyph_draw_dsc) {
        ...
        case LV_FONT_GLYPH_FORMAT_A1 ... LV_FONT_GLYPH_FORMAT_A8: {
            ...
            mask_area.x2 =
                mask_area.x1 + lv_draw_buf_width_to_stride(lv_area_get_width(&mask_area), LV_COLOR_FORMAT_A8) - 1;
...
#endif
            d2_settexture(
                unit->d2_handle, (void *)draw_buf->data,
            ...
            d2_settexturemapping(unit->d2_handle, D2_FIX4(letter_coords.x1), D2_FIX4(letter_coords.y1), D2_FIX16(0),
                                 D2_FIX16(0), D2_FIX16(1), D2_FIX16(0), D2_FIX16(0), D2_FIX16(1));

            d2_settexturemode(unit->d2_handle, d2_tm_filter);

            d2_setfillmode(unit->d2_handle, d2_fm_texture);

            d2_renderbox(unit->d2_handle, (d2_point)D2_FIX4(letter_coords.x1), (d2_point)D2_FIX4(letter_coords.y1),
