...
void lv_draw_dave2d_fill(lv_draw_dave2d_unit_t *u, const lv_draw_fill_dsc_t *dsc, const lv_area_t *coords)
{
    ...
    if (LV_GRAD_DIR_NONE != dsc->grad.dir) {
        ...
        if (LV_GRAD_DIR_VER == dsc->grad.dir) {
            ...
            d2_setalphagradient(u->d2_handle, 0, (d2_point)D2_FIX4(x0_i), (d2_point)D2_FIX4(0),
                                (d2_point)D2_FIX4(x3_i - x0_i), (d2_point)D2_FIX4((0)));
        }
    ...
    if (dsc->radius == 0) {
        ...
        d2_renderbox(u->d2_handle, (d2_point)D2_FIX4(coordinates.x1), (d2_point)D2_FIX4(coordinates.y1),
        ...
        if (((2 * radius) == coords_bg_w) && ((2 * radius) == coords_bg_h)) {
            result = d2_rendercircle(u->d2_handle, (d2_point)D2_FIX4(arc_centre.x), (d2_point)D2_FIX4(arc_centre.y),
                                     (d2_width)D2_FIX4(radius), (d2_width)D2_FIX4(0));
            ...
            if (lv_area_intersect(&clip_arc, &arc_area, &draw_area)) {
                ...
                // d2_renderwedge internally changes the clip rectangle, only draw it if it is in side the current clip
                // rectangle
            ...
            result = d2_renderbox(u->d2_handle, (d2_width)D2_FIX4(coordinates.x1 + radius),
            ...
            result = d2_renderbox(u->d2_handle, (d2_width)D2_FIX4(coordinates.x1),
                                  (d2_width)D2_FIX4(coordinates.y1 + radius), (d2_width)D2_FIX4(radius),
                                  (d2_width)D2_FIX4(lv_area_get_height(&coordinates) - (2 * radius)));
            LV_ASSERT(D2_OK == result);

            result = d2_renderbox(u->d2_handle, (d2_width)D2_FIX4(coordinates.x2 - radius),
                                  (d2_width)D2_FIX4(coordinates.y1 + radius), (d2_width)D2_FIX4(radius),
                                  (d2_width)D2_FIX4(lv_area_get_height(&coordinates) - (2 * radius)));
            LV_ASSERT(D2_OK == result);
        }
