 ...
 *
 */
static void _vglite_draw_line(const lv_point_t *point1, const lv_point_t *point2, const lv_area_t *clip_area,
                              ...
                              const lv_draw_line_dsc_t *dsc)
{
    ...
    int32_t line_path[] = {/*VG line path*/
                           VLC_OP_MOVE, point1->x, point1->y, VLC_OP_LINE, point2->x, point2->y, VLC_OP_END};
    ...
    VGLITE_CHECK_ERROR(vg_lite_set_stroke(&path, cap_style, join_style, width, 8, stroke_dash_pattern,
                                          stroke_dash_count, stroke_dash_phase, vgcol));
