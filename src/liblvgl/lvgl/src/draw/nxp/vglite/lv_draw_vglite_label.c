...
static void _vglite_draw_letter(const lv_area_t *mask_area, lv_color_t color, lv_opa_t opa)
{
    ...
    vg_lite_rectangle_t rect = {.x = (vg_lite_int32_t)mask_area->x1,
    ...
    VGLITE_CHECK_ERROR(
        vg_lite_blit_rect(dst_vgbuf, mask_vgbuf, &rect, vgmatrix, VG_LITE_BLEND_SRC_OVER, vgcol, VG_LITE_FILTER_POINT));
