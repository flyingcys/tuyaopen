 ...
 *  STATIC PROTOTYPES
 **********************/
static lv_draw_sw_mask_res_t /* LV_ATTRIBUTE_FAST_MEM */
lv_draw_mask_line(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y, int32_t len, lv_draw_sw_mask_line_param_t *param);
...
static lv_draw_sw_mask_res_t /* LV_ATTRIBUTE_FAST_MEM */
lv_draw_mask_angle(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y, int32_t len, lv_draw_sw_mask_angle_param_t *param);
static lv_draw_sw_mask_res_t /* LV_ATTRIBUTE_FAST_MEM */
lv_draw_mask_fade(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y, int32_t len, lv_draw_sw_mask_fade_param_t *param);
static lv_draw_sw_mask_res_t /* LV_ATTRIBUTE_FAST_MEM */
lv_draw_mask_map(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y, int32_t len, lv_draw_sw_mask_map_param_t *param);

static lv_draw_sw_mask_res_t /* LV_ATTRIBUTE_FAST_MEM */
line_mask_flat(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y, int32_t len, lv_draw_sw_mask_line_param_t *p);
static lv_draw_sw_mask_res_t /* LV_ATTRIBUTE_FAST_MEM */
line_mask_steep(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y, int32_t len, lv_draw_sw_mask_line_param_t *p);
...
static lv_opa_t *get_next_line(lv_draw_sw_mask_radius_circle_dsc_t *c, int32_t y, int32_t *len, int32_t *x_start);
...
void lv_draw_sw_mask_line_points_init(lv_draw_sw_mask_line_param_t *param, int32_t p1x, int32_t p1y, int32_t p2x,
...
void lv_draw_sw_mask_fade_init(lv_draw_sw_mask_fade_param_t *param, const lv_area_t *coords, lv_opa_t opa_top,
                               int32_t y_top, lv_opa_t opa_bottom, int32_t y_bottom)
{
...
static lv_draw_sw_mask_res_t LV_ATTRIBUTE_FAST_MEM lv_draw_mask_line(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y,
                                                                     int32_t len, lv_draw_sw_mask_line_param_t *p)
{
    ...
    if (p->steep == 0) {
        ...
        if (p->flat) {
            ...
            if (p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_LEFT || p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_RIGHT)
        ...
        /*Vertical*/
            ...
            if (p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_TOP || p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_BOTTOM)
                return LV_DRAW_SW_MASK_RES_FULL_COVER;
...
static lv_draw_sw_mask_res_t LV_ATTRIBUTE_FAST_MEM line_mask_flat(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y,
                                                                  int32_t len, lv_draw_sw_mask_line_param_t *p)
{
...
static lv_draw_sw_mask_res_t LV_ATTRIBUTE_FAST_MEM line_mask_steep(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y,
                                                                   int32_t len, lv_draw_sw_mask_line_param_t *p)
{
    int32_t k;
    int32_t x_at_y;
...
static lv_draw_sw_mask_res_t LV_ATTRIBUTE_FAST_MEM lv_draw_mask_angle(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y,
                                                                      int32_t len, lv_draw_sw_mask_angle_param_t *p)
{
    ...
    if (p->cfg.start_angle < 180 && p->cfg.end_angle < 180 && p->cfg.start_angle != 0 && p->cfg.end_angle != 0 &&
        ...
        res2 = lv_draw_mask_line(&mask_buf[tmp], abs_x + tmp, abs_y, len - tmp,
                                 (lv_draw_sw_mask_line_param_t *)&p->start_line);
        if (res2 == LV_DRAW_SW_MASK_RES_TRANSP) {
            lv_memzero(&mask_buf[tmp], len - tmp);
        }
        if (res1 == res2)
        ...
        if (res1 == LV_DRAW_SW_MASK_RES_TRANSP || res2 == LV_DRAW_SW_MASK_RES_TRANSP)
            ...
            return LV_DRAW_SW_MASK_RES_TRANSP;
        else if (res1 == LV_DRAW_SW_MASK_RES_FULL_COVER && res2 == LV_DRAW_SW_MASK_RES_FULL_COVER)
            return LV_DRAW_SW_MASK_RES_FULL_COVER;
        else
            return LV_DRAW_SW_MASK_RES_CHANGED;
    }
...
static lv_draw_sw_mask_res_t LV_ATTRIBUTE_FAST_MEM lv_draw_mask_radius(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y,
...
static lv_draw_sw_mask_res_t LV_ATTRIBUTE_FAST_MEM lv_draw_mask_fade(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y,
                                                                     int32_t len, lv_draw_sw_mask_fade_param_t *p)
{
...
static lv_draw_sw_mask_res_t LV_ATTRIBUTE_FAST_MEM lv_draw_mask_map(lv_opa_t *mask_buf, int32_t abs_x, int32_t abs_y,
                                                                    int32_t len, lv_draw_sw_mask_map_param_t *p)
{
