...
#define LV_DRAW_SW_COLOR_BLEND_TO_RGB565(dsc) lv_color_blend_to_rgb565_arm2d(dsc)
#endif

#ifndef LV_DRAW_SW_COLOR_BLEND_TO_RGB565_WITH_OPA
#define LV_DRAW_SW_COLOR_BLEND_TO_RGB565_WITH_OPA(dsc) lv_color_blend_to_rgb565_with_opa_arm2d(dsc)
#endif

#ifndef LV_DRAW_SW_COLOR_BLEND_TO_RGB565_WITH_MASK
#define LV_DRAW_SW_COLOR_BLEND_TO_RGB565_WITH_MASK(dsc) lv_color_blend_to_rgb565_with_mask_arm2d(dsc)
#endif

#ifndef LV_DRAW_SW_COLOR_BLEND_TO_RGB565_MIX_MASK_OPA
#define LV_DRAW_SW_COLOR_BLEND_TO_RGB565_MIX_MASK_OPA(dsc) lv_color_blend_to_rgb565_mix_mask_opa_arm2d(dsc)
#endif

#ifndef LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565
#define LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565(dsc) lv_rgb565_blend_normal_to_rgb565_arm2d(dsc)
#endif

#ifndef LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565_WITH_OPA
#define LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565_WITH_OPA(dsc) lv_rgb565_blend_normal_to_rgb565_with_opa_arm2d(dsc)
#endif

#ifndef LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565_WITH_MASK
#define LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565_WITH_MASK(dsc) lv_rgb565_blend_normal_to_rgb565_with_mask_arm2d(dsc)
#endif
...
#define LV_DRAW_SW_ARGB8888_BLEND_NORMAL_TO_RGB565(dsc) lv_argb8888_blend_normal_to_rgb565_arm2d(dsc)
#endif

#ifndef LV_DRAW_SW_ARGB8888_BLEND_NORMAL_TO_RGB565_WITH_OPA
#define LV_DRAW_SW_ARGB8888_BLEND_NORMAL_TO_RGB565_WITH_OPA(dsc) lv_argb8888_blend_normal_to_rgb565_with_opa_arm2d(dsc)
#endif
...
#define LV_DRAW_SW_COLOR_BLEND_TO_RGB888(dsc, dst_px_size) lv_color_blend_to_rgb888_arm2d(dsc, dst_px_size)
#endif
...
static inline lv_result_t lv_color_blend_to_rgb565_arm2d(lv_draw_sw_blend_fill_dsc_t *dsc)
{
    ...
    __arm_2d_impl_rgb16_colour_filling((uint16_t *)dsc->dest_buf, stride, &draw_size, lv_color_to_u16(dsc->color));
    return LV_RESULT_OK;
}
...
static inline lv_result_t lv_color_blend_to_rgb565_with_opa_arm2d(lv_draw_sw_blend_fill_dsc_t *dsc)
{
    arm_2d_size_t draw_size = {dsc->dest_w, dsc->dest_h};
    int16_t stride = (dsc->dest_stride) / sizeof(uint16_t);
    __arm_2d_impl_rgb565_colour_filling_with_opacity((uint16_t *)dsc->dest_buf, stride, &draw_size,
...
static inline lv_result_t lv_color_blend_to_rgb565_with_mask_arm2d(lv_draw_sw_blend_fill_dsc_t *dsc)
{
    arm_2d_size_t draw_size = {dsc->dest_w, dsc->dest_h};
    int16_t stride = (dsc->dest_stride) / sizeof(uint16_t);
    __arm_2d_impl_rgb565_colour_filling_mask((uint16_t *)dsc->dest_buf, stride, (uint8_t *)dsc->mask_buf,
                                             dsc->mask_stride, &draw_size, lv_color_to_u16(dsc->color));
    return LV_RESULT_OK;
}
...
static inline lv_result_t lv_color_blend_to_rgb565_mix_mask_opa_arm2d(lv_draw_sw_blend_fill_dsc_t *dsc)
{
    arm_2d_size_t draw_size = {dsc->dest_w, dsc->dest_h};
    int16_t stride = (dsc->dest_stride) / sizeof(uint16_t);
    __arm_2d_impl_rgb565_colour_filling_mask_opacity((uint16_t *)dsc->dest_buf, stride, (uint8_t *)dsc->mask_buf,
                                                     dsc->mask_stride, &draw_size, lv_color_to_u16(dsc->color),
                                                     dsc->opa);
    return LV_RESULT_OK;
}
...
static inline lv_result_t lv_rgb565_blend_normal_to_rgb565_arm2d(lv_draw_sw_blend_image_dsc_t *dsc)
{
    ...
    __arm_2d_impl_rgb16_copy((uint16_t *)dsc->src_buf, src_stride, (uint16_t *)dsc->dest_buf, des_stride, &draw_size);
    return LV_RESULT_OK;
}
...
static inline lv_result_t lv_rgb565_blend_normal_to_rgb565_with_opa_arm2d(lv_draw_sw_blend_image_dsc_t *dsc)
{
    ...
    int16_t des_stride = dsc->dest_stride / sizeof(uint16_t);
    int16_t src_stride = dsc->src_stride / sizeof(uint16_t);
    __arm_2d_impl_rgb565_tile_copy_opacity((uint16_t *)dsc->src_buf, src_stride, (uint16_t *)dsc->dest_buf, des_stride,
                                           &draw_size, dsc->opa);
    return LV_RESULT_OK;
}
...
static inline lv_result_t lv_rgb565_blend_normal_to_rgb565_with_mask_arm2d(lv_draw_sw_blend_image_dsc_t *dsc)
{
    ...
    int16_t des_stride = dsc->dest_stride / sizeof(uint16_t);
    int16_t src_stride = dsc->src_stride / sizeof(uint16_t);
    __arm_2d_impl_rgb565_src_msk_copy((uint16_t *)dsc->src_buf, src_stride, (uint8_t *)dsc->mask_buf, dsc->mask_stride,
                                      &draw_size, (uint16_t *)dsc->dest_buf, des_stride, &draw_size);
    return LV_RESULT_OK;
}
...
static inline lv_result_t lv_rgb565_blend_normal_to_rgb565_mix_mask_opa_arm2d(lv_draw_sw_blend_image_dsc_t *dsc)
{
    ...
    __arm_2d_impl_rgb565_tile_copy_with_src_mask_and_opacity(
        (uint16_t *)dsc->src_buf, src_stride, (uint8_t *)dsc->mask_buf, dsc->mask_stride, &draw_size,
        (uint16_t *)dsc->dest_buf, des_stride, &draw_size, dsc->opa);
    return LV_RESULT_OK;
}
                                                                 ...
                                                                 uint32_t src_px_size)
{
    ...
    __arm_2d_impl_cccn888_to_rgb565((uint32_t *)dsc->src_buf, src_stride, (uint16_t *)dsc->dest_buf, des_stride,
                                    &draw_size);
                                                                          ...
                                                                          uint32_t src_px_size)
{
    ...
    __arm_2d_impl_cccn888_to_rgb565((uint32_t *)dsc->src_buf, src_stride, (uint16_t *)tmp_buf, des_stride, &draw_size);

    __arm_2d_impl_rgb565_tile_copy_opacity(tmp_buf, des_stride, (uint16_t *)dsc->dest_buf, des_stride, &draw_size,
                                           dsc->opa);
#else
    __arm_2d_impl_ccca8888_tile_copy_to_rgb565_with_opacity(
        (uint32_t *)dsc->src_buf, src_stride, (uint16_t *)dsc->dest_buf, des_stride, &draw_size, dsc->opa);
#endif
    lv_free(tmp_buf);
    return LV_RESULT_OK;
}
                                                                           ...
                                                                           uint32_t src_px_size)
{
    ...
    __arm_2d_impl_rgb565_src_msk_copy(tmp_buf, des_stride, (uint8_t *)dsc->mask_buf, dsc->mask_stride, &draw_size,
                                      (uint16_t *)dsc->dest_buf, des_stride, &draw_size);
#else
    __arm_2d_impl_ccca8888_tile_copy_to_rgb565_with_src_mask((uint32_t *)dsc->src_buf, src_stride,
                                                             (uint8_t *)dsc->mask_buf, dsc->mask_stride, &draw_size,
                                                             (uint16_t *)dsc->dest_buf, des_stride, &draw_size);
#endif
                                                                              ...
                                                                              uint32_t src_px_size)
{
    ...
    __arm_2d_impl_rgb565_tile_copy_with_src_mask_and_opacity(tmp_buf, des_stride, (uint8_t *)dsc->mask_buf,
                                                             dsc->mask_stride, &draw_size, (uint16_t *)dsc->dest_buf,
                                                             des_stride, &draw_size, dsc->opa);
#else
    __arm_2d_impl_ccca8888_tile_copy_to_rgb565_with_src_mask_and_opacity(
        (uint32_t *)dsc->src_buf, src_stride, (uint8_t *)dsc->mask_buf, dsc->mask_stride, &draw_size,
        (uint16_t *)dsc->dest_buf, des_stride, &draw_size, dsc->opa);
#endif
...
static inline lv_result_t lv_argb8888_blend_normal_to_rgb565_arm2d(lv_draw_sw_blend_image_dsc_t *dsc)
{
    ...
    __arm_2d_impl_ccca8888_to_rgb565((uint32_t *)dsc->src_buf, src_stride, (uint16_t *)dsc->dest_buf, des_stride,
                                     &draw_size);
...
static inline lv_result_t lv_color_blend_to_rgb888_arm2d(lv_draw_sw_blend_fill_dsc_t *dsc, uint32_t dst_px_size)
{
    ...
    __arm_2d_impl_rgb32_colour_filling((uint32_t *)dsc->dest_buf, stride, &draw_size, lv_color_to_u32(dsc->color));
    return LV_RESULT_OK;
}
                                                                  ...
                                                                  uint32_t dst_px_size)
{
    ...
    arm_2d_size_t draw_size = {dsc->dest_w, dsc->dest_h};
    int16_t stride = (dsc->dest_stride) / sizeof(uint32_t);
    __arm_2d_impl_cccn888_colour_filling_with_opacity((uint32_t *)dsc->dest_buf, stride, &draw_size,
                                                      lv_color_to_u32(dsc->color), dsc->opa);
    return LV_RESULT_OK;
}
                                                                   ...
                                                                   uint32_t dst_px_size)
{
    ...
    arm_2d_size_t draw_size = {dsc->dest_w, dsc->dest_h};
    int16_t stride = (dsc->dest_stride) / sizeof(uint32_t);
    __arm_2d_impl_cccn888_colour_filling_mask((uint32_t *)dsc->dest_buf, stride, (uint8_t *)dsc->mask_buf,
                                              dsc->mask_stride, &draw_size, lv_color_to_u32(dsc->color));
    return LV_RESULT_OK;
}
                                                                      ...
                                                                      uint32_t dst_px_size)
{
    ...
    arm_2d_size_t draw_size = {dsc->dest_w, dsc->dest_h};
    int16_t stride = (dsc->dest_stride) / sizeof(uint32_t);
    __arm_2d_impl_cccn888_colour_filling_mask_opacity((uint32_t *)dsc->dest_buf, stride, (uint8_t *)dsc->mask_buf,
                                                      dsc->mask_stride, &draw_size, lv_color_to_u32(dsc->color),
                                                      dsc->opa);
    return LV_RESULT_OK;
}
                                                                 ...
                                                                 uint32_t dst_px_size)
{
    ...
    __arm_2d_impl_rgb565_to_cccn888((uint16_t *)dsc->src_buf, src_stride, (uint32_t *)dsc->dest_buf, des_stride,
                                    &draw_size);
                                                                          ...
                                                                          uint32_t dst_px_size)
{
    ...
    /* get rgb565 */
    __arm_2d_impl_rgb565_to_cccn888((uint16_t *)dsc->src_buf, src_stride, (uint32_t *)tmp_buf, des_stride, &draw_size);

    __arm_2d_impl_cccn888_tile_copy_opacity(tmp_buf, des_stride, (uint32_t *)dsc->dest_buf, des_stride, &draw_size,
                                            dsc->opa);
                                                                           ...
                                                                           uint32_t dst_px_size)
{
    ...
    __arm_2d_impl_cccn888_src_msk_copy(tmp_buf, des_stride, (uint8_t *)dsc->mask_buf, dsc->mask_stride, &draw_size,
                                       (uint32_t *)dsc->dest_buf, des_stride, &draw_size);
                                                                              ...
                                                                              uint32_t dst_px_size)
{
    ...
    __arm_2d_impl_cccn888_tile_copy_with_src_mask_and_opacity(tmp_buf, des_stride, (uint8_t *)dsc->mask_buf,
                                                              dsc->mask_stride, &draw_size, (uint32_t *)dsc->dest_buf,
                                                              des_stride, &draw_size, dsc->opa);
                                                                 ...
                                                                 uint32_t dst_px_size, uint32_t src_px_size)
{
    ...
    __arm_2d_impl_rgb32_copy((uint32_t *)dsc->src_buf, src_stride, (uint32_t *)dsc->dest_buf, des_stride, &draw_size);
                                                                          ...
                                                                          uint32_t dst_px_size, uint32_t src_px_size)
{
    ...
    __arm_2d_impl_cccn888_tile_copy_opacity((uint32_t *)dsc->src_buf, src_stride, (uint32_t *)dsc->dest_buf, des_stride,
                                            &draw_size, dsc->opa);
                                                                           ...
                                                                           uint32_t dst_px_size, uint32_t src_px_size)
{
    ...
    __arm_2d_impl_cccn888_src_msk_copy((uint32_t *)dsc->src_buf, src_stride, (uint8_t *)dsc->mask_buf, dsc->mask_stride,
                                       &draw_size, (uint32_t *)dsc->dest_buf, des_stride, &draw_size);
    return LV_RESULT_OK;
}
                                                                              ...
                                                                              uint32_t src_px_size)
{
    ...
    __arm_2d_impl_cccn888_tile_copy_with_src_mask_and_opacity(
        (uint32_t *)dsc->src_buf, src_stride, (uint8_t *)dsc->mask_buf, dsc->mask_stride, &draw_size,
        (uint32_t *)dsc->dest_buf, des_stride, &draw_size, dsc->opa);
    return LV_RESULT_OK;
}
                                                                   ...
                                                                   uint32_t dst_px_size)
{
    ...
    __arm_2d_impl_ccca8888_to_cccn888((uint32_t *)dsc->src_buf, src_stride, (uint32_t *)dsc->dest_buf, des_stride,
                                      &draw_size);
                                                                            ...
                                                                            uint32_t dst_px_size)
{
    ...
    __arm_2d_impl_ccca8888_tile_copy_to_cccn888_with_opacity(
        (uint32_t *)dsc->src_buf, src_stride, (uint32_t *)dsc->dest_buf, des_stride, &draw_size, dsc->opa);
                                                                             ...
                                                                             uint32_t dst_px_size)
{
    ...
    __arm_2d_impl_ccca8888_tile_copy_to_cccn888_with_src_mask((uint32_t *)dsc->src_buf, src_stride,
                                                              (uint8_t *)dsc->mask_buf, dsc->mask_stride, &draw_size,
                                                              (uint32_t *)dsc->dest_buf, des_stride, &draw_size);
