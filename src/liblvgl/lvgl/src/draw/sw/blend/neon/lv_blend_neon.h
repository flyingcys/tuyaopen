...
static inline lv_result_t lv_rgb888_blend_normal_to_rgb565_neon(lv_draw_sw_blend_image_dsc_t *dsc, uint32_t src_px_size)
{
    asm_dsc_t asm_dsc = {.dst_buf = dsc->dest_buf,
                         .dst_w = dsc->dest_w,
                         .dst_h = dsc->dest_h,
...
static inline lv_result_t lv_color_blend_to_rgb888_with_opa_neon(lv_draw_sw_blend_fill_dsc_t *dsc, uint32_t dst_px_size)
{
    asm_dsc_t asm_dsc = {.opa = dsc->opa,
                         .dst_buf = dsc->dest_buf,
                         .dst_w = dsc->dest_w,
...
static inline lv_result_t lv_rgb565_blend_normal_to_rgb888_neon(lv_draw_sw_blend_image_dsc_t *dsc, uint32_t dst_px_size)
{
    asm_dsc_t asm_dsc = {.dst_buf = dsc->dest_buf,
                         .dst_w = dsc->dest_w,
                         .dst_h = dsc->dest_h,
...
static inline lv_result_t lv_rgb888_blend_normal_to_rgb888_neon(lv_draw_sw_blend_image_dsc_t *dsc, uint32_t dst_px_size,
                                                                uint32_t src_px_size)
{
    asm_dsc_t asm_dsc = {.dst_buf = dsc->dest_buf,
                         .dst_w = dsc->dest_w,
