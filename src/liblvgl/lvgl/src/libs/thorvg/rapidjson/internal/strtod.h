...
template <typename Ch> inline bool StrtodDiyFp(const Ch *decimals, int dLen, int dExp, double *result)
{
...
template <typename Ch> inline double StrtodBigInteger(double approx, const Ch *decimals, int dLen, int dExp)
{
