...
static int32_t find_track_end(lv_obj_t *cont, flex_t *f, int32_t item_start_id, int32_t max_main_size, int32_t item_gap,
                              track_t *t);
                              ...
                              track_t *t)
{
    ...
    int32_t (*get_main_size)(const lv_obj_t *) =
...
static int32_t lv_obj_get_width_with_margin(const lv_obj_t *obj)
{
    return lv_obj_get_style_margin_left(obj, LV_PART_MAIN) + lv_obj_get_width(obj) +
           lv_obj_get_style_margin_right(obj, LV_PART_MAIN);
}

static int32_t lv_obj_get_height_with_margin(const lv_obj_t *obj)
{
    return lv_obj_get_style_margin_top(obj, LV_PART_MAIN) + lv_obj_get_height(obj) +
