...
static const uint8_t init_cmd_list[] = {
    ...
    CMD_PWCTR2,
    1,
    0x06, /* Power control2: VAP(GVDD) = 3.85 + (vcom + vcom offset), VAN(GVCL) = -3.85 + (vcom + vcom offset) */
    CMD_PWCTR3,
    1,
    0xA7, /* Power control 3: Source driving current level = low, Gamma driving current level = High */
    CMD_VMCTR,
    1,
    0x18, /* VCOM Control: VCOM = 0.9 */
    LV_LCD_CMD_DELAY_MS,
    12, /* delay 120 ms */
    CMD_GMCTRP1,
    14, /* Gamma */
