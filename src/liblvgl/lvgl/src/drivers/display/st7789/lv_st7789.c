...
static const uint8_t init_cmd_list[] = {CMD_GCTRL,
                                        1,
                                        0x44, /* GCTRL -- panel dependent */
                                        CMD_VCOMS,
                                        1,
                                        0x24, /* VCOMS -- panel dependent */
                                        CMD_VRHS,
                                        1,
                                        0x13, /* VRHS - panel dependent */
                                        CMD_PWCTRL1,
                                        2,
                                        0xa4,
                                        0xa1,
                                        ...
                                        2,
                                        0x00,
                                        0xC0, /* controls mapping of RGB565 to RGB666 */
                                        CMD_PVGAMCTRL,
                                        14,
                                        0xd0,
                                        0x00,
