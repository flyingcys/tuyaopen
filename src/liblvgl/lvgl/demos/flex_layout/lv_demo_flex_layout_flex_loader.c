...
#define FLEX_ALIGN_EVENT_ATTACH(item)                                                                                  \
    do {                                                                                                               \
        lv_obj_add_event_cb(ui->ctrl_pad.tab.align.ddlist_align_##item, flex_align_##item##_event_handler,             \
...
static const lv_flex_flow_t flex_flow_map[] = {LV_FLEX_FLOW_ROW,
                                               LV_FLEX_FLOW_COLUMN,
...
{
    lv_obj_add_event_cb(ui->ctrl_pad.tab.flex.ddlist_flow, flex_flow_event_handler, LV_EVENT_VALUE_CHANGED, ui);
