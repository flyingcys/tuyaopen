...
static void profile_create(lv_obj_t *parent)
{
    ...
    if (disp_size == DISP_LARGE) {
        ...
        static int32_t grid_1_row_dsc[] = {LV_GRID_CONTENT, LV_GRID_CONTENT, 10,
        ...
        static int32_t grid_2_row_dsc[] = {LV_GRID_CONTENT, /*Title*/
                                           5,               /*Separator*/
        ...
        static int32_t grid_1_row_dsc[] = {LV_GRID_CONTENT, /*Name*/
...
static void analytics_create(lv_obj_t *parent)
{
    ...
    static const char *chart1_texts[] = {"Jan", "Feb",  "March", "April", "May", "Jun", "July",
    ...
    static const char *chart2_texts[] = {"I",    "II", "III", "IV", "V",   "VI", "VII",
                                         "VIII", "IX", "X",   "XI", "XII", NULL};
...
void shop_create(lv_obj_t *parent)
{
    ...
    if (disp_size == DISP_LARGE) {
        ...
        static int32_t grid1_row_dsc[] = {LV_GRID_CONTENT, /*Title*/
        ...
        static int32_t grid1_col_dsc[] = {LV_GRID_FR(1), LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
        static int32_t grid1_row_dsc[] = {LV_GRID_CONTENT, /*Title + Date*/
...
static void color_changer_create(lv_obj_t *parent)
{
    static lv_palette_t palette[] = {LV_PALETTE_BLUE, LV_PALETTE_GREEN,  LV_PALETTE_BLUE_GREY, LV_PALETTE_ORANGE,
                                  ...
                                  const char *text3)
{
    ...
    if (disp_size == DISP_MEDIUM) {
        static int32_t grid_col_dsc[] = {LV_GRID_CONTENT, LV_GRID_FR(1), LV_GRID_CONTENT, LV_GRID_FR(8),
                                         LV_GRID_TEMPLATE_LAST};
        static int32_t grid_row_dsc[] = {LV_GRID_CONTENT, LV_GRID_FR(1), LV_GRID_CONTENT,      LV_GRID_CONTENT,
...
static void chart_event_cb(lv_event_t *e)
{
    ...
    if (code == LV_EVENT_PRESSED || code == LV_EVENT_RELEASED) {
        ...
        if (base_dsc->part == LV_PART_ITEMS && draw_line_dsc) {
            ...
            tri_dsc.p[2].x =
                (int32_t)(draw_line_dsc->p1.y < draw_line_dsc->p2.y ? draw_line_dsc->p1.x : draw_line_dsc->p2.x);
            tri_dsc.p[2].y = (int32_t)LV_MAX(draw_line_dsc->p1.y, draw_line_dsc->p2.y);
            tri_dsc.bg_grad.dir = LV_GRAD_DIR_VER;

            int32_t full_h = lv_obj_get_height(obj);
            int32_t fract_uppter =
                (int32_t)(LV_MIN(draw_line_dsc->p1.y, draw_line_dsc->p2.y) - obj_coords.y1) * 255 / full_h;
            int32_t fract_lower =
                (int32_t)(LV_MAX(draw_line_dsc->p1.y, draw_line_dsc->p2.y) - obj_coords.y1) * 255 / full_h;
        ...
        if (add_value) {
            ...
            char buf[8];
            lv_snprintf(buf, sizeof(buf), "%" LV_PRId32,
                        lv_chart_get_y_array(obj, (lv_chart_series_t *)ser)[base_dsc->id2]);
