...
{
    lv_color_t colors[] = {
        lv_color_hex3(0x000), lv_color_hex3(0xfff), lv_color_hex3(0xf00), lv_color_hex3(0x0f0),
        lv_color_hex3(0x00f), lv_color_hex3(0xff0), lv_color_hex3(0x0ff), lv_color_hex3(0xf0f),
    };
...
static void image_core_cb(lv_obj_t *parent, bool recolor, uint32_t startAt)
{
    ...
    const void *srcs[] = {
        &img_render_lvgl_logo_argb8888, &img_render_lvgl_logo_xrgb8888, &img_render_lvgl_logo_rgb888,
        &img_render_lvgl_logo_rgb565,   &img_render_lvgl_logo_l8,       &img_render_lvgl_logo_i1,
    };
...
static lv_obj_t *arc_obj_create(lv_obj_t *parent, int32_t col, int32_t row, int32_t w, lv_value_precise_t start,
...
static void arc_core_cb(lv_obj_t *parent, const void *img_src)
{
    static lv_value_precise_t angles[][2] = {
        {355, 5}, {85, 95}, {175, 185}, {265, 275}, {30, 330}, {120, 60}, {0, 180}, {0, 360},
    };
...
static void blend_mode_cb(lv_obj_t *parent)
{
    ...
    lv_color_format_t cf_values[] = {LV_COLOR_FORMAT_RGB565, LV_COLOR_FORMAT_RGB888, LV_COLOR_FORMAT_XRGB8888,
...
static lv_obj_t *create_linear_gradient_obj(lv_obj_t *parent, int32_t col, int32_t row, lv_grad_dsc_t *grad, int32_t x1,
                                            int32_t y1, lv_grad_extend_t extend, bool use_opa_map, int32_t radius)
{
    ...
    lv_gradient_init_stops(grad, grad_color, use_opa_map ? grad_opa : NULL, NULL,
                           sizeof(grad_color) / sizeof(lv_color_t));
...
static lv_obj_t *create_radial_gradient_obj(lv_obj_t *parent, int32_t col, int32_t row, lv_grad_dsc_t *grad,
                                            int32_t offs, int32_t r0, lv_grad_extend_t extend, bool use_opa_map,
                                            int32_t radius)
{
    const lv_color_t grad_color[2] = {
        LV_COLOR_MAKE(0xd5, 0x03, 0x47),
...
static lv_obj_t *create_conical_gradient_obj(lv_obj_t *parent, int32_t col, int32_t row, lv_grad_dsc_t *grad,
                                             int32_t a0, int32_t a1, lv_grad_extend_t extend, bool use_opa_map,
                                             int32_t radius)
{
    const lv_color_t grad_color[2] = {
        LV_COLOR_MAKE(0xd5, 0x03, 0x47),
...
static scene_dsc_t scenes[] = {{.name = "fill", .create_cb = fill_cb},
