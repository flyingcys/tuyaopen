 ...
 *      MACROS
 **********************/
#define CARD_INFO_SET(_image, _name, _description)                                                                     \
    {                                                                                                                  \
        .image = _image, .name = _name, .description = _description                                                    \
    }
...
static card_info_t card_info[] = {
    ...
    CARD_INFO_SET(&img_multilang_avatar_18, "Ali Reza Karami",
                  "عاشق تاریخ و عاشق همه چیز عتیقه. قسمت مورد علاقه من قرن 19 است."),
    CARD_INFO_SET(&img_multilang_avatar_25, "Sunita Kapoor", "🌍🌳 हरित कार्यकर्ता, एक स्थायी कल के लिए प्रयासरत। "),
    CARD_INFO_SET(&img_multilang_avatar_2, "Sofia Bianchi",
                  "Aspirante romanziere con la passione per il caffè e i gatti 🐱"),
    ...
    CARD_INFO_SET(&img_multilang_avatar_7, "Ahmad Al-Masri",
                  "عاشق للأفلام وناقد سينمائي عرضي. معجب بستيفن سبيلبرغ (Steven Spielberg). "),
    CARD_INFO_SET(&img_multilang_avatar_4, "Ingrid Johansen",
                  "Håpløs romantisk søker etter den spesielle personen ❤️"),
    ...
    CARD_INFO_SET(&img_multilang_avatar_10, "James Wilson",
                  "Foodie with a passion for trying new restaurants and dishes"),
    CARD_INFO_SET(&img_multilang_avatar_11, "Olivia Marie Parker",
                  "Gamer at heart, always up for a good round of Mario Kart "),
