...
static lv_obj_t *create_panel(int32_t radius, bool transform)
{
    ...
    lv_label_set_text(label, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus dignissim quam id eros "
                             "iaculis dapibus. Mauris nisl orci, vulputate sed eleifend a, consectetur et nulla.");
