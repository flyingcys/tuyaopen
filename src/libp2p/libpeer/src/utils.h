...
// #define PR_DEBUG(fmt, ...) LOG_PRINT(DEBUG_TAG, fmt, ##__VA_ARGS__)
// #else
// #define PR_DEBUG(fmt, ...)
// #endif

// #if LOG_LEVEL >= LEVEL_INFO
// #define PR_NOTICE(fmt, ...) LOG_PRINT(INFO_TAG, fmt, ##__VA_ARGS__)
// #else
// #define PR_NOTICE(fmt, ...)
// #endif

// #if LOG_LEVEL >= LEVEL_WARN
// #define PR_NOTICE(fmt, ...) LOG_PRINT(WARN_TAG, fmt, ##__VA_ARGS__)
// #else
// #define PR_NOTICE(fmt, ...)
// #endif

// #if LOG_LEVEL >= LEVEL_ERROR
// #define PR_ERR(fmt, ...) LOG_PRINT(ERROR_TAG, fmt, ##__VA_ARGS__)
// #else
// #define PR_ERR(fmt, ...)
// #endif
